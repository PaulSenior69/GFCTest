        ...
        startTimer: function () {
            ...
            if (minutes) {
                ...
                (function runTimer() {
                    ...
                    try {
                        atMinutesNumberAsText = GOVUK.modalDialog.numberToWords(minutesLeft); // Attempt to convert numerics into text as iOS VoiceOver occassionally stalled when encountering numbers
